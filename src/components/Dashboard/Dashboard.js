        ...
        >
          <Row>
            <Card style={cardStyle} md={4}>
              ...
              <Button style={button}>View All Customers</Button>
            </Card>
          </Row>
          <Row>
            <Card style={cardStyle} md={4}>
              ...
              <Button style={button}>Create Customer</Button>
            </Card>
          </Row>
          <Row>
            <Card style={cardStyle} md={4}>
              ...
              <Button style={button}>View All Addresses</Button>
            </Card>
          </Row>
          <Row>
            <Card style={cardStyle} md={4}>
              ...
              <Button style={button}>Create New Address</Button>
            </Card>
          </Row>
          <Row>
            <Card style={cardStyle} md={4}>
              ...
              <Button style={button}>View All Orders</Button>
            </Card>
          </Row>
          <Row>
            <Card style={cardStyle} md={4}>
              ...
              <Button style={button}>Create New Order</Button>
            </Card>
          </Row>
          <Row>
            <Card style={cardStyle} md={4}>
              ...
              <Button style={button}>View All Products</Button>
            </Card>
          </Row>
          <Row>
            <Card style={cardStyle} md={4}>
              ...
              <Button style={button}>Create New Product</Button>
            </Card>
          </Row>
        </Container>
      </div>
